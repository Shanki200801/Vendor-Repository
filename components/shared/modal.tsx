    ...
    <Dialog.Root open={showModal} onOpenChange={setShowModal}>
      <Dialog.Portal>
        ...
        <Dialog.Content
          ...
          className={cn(
            "animate-scale-in fixed inset-0 z-40 m-auto h-1/2 max-h-fit w-full max-w-md overflow-hidden border border-gray-200 bg-white p-0 shadow-xl md:rounded-2xl",
            className,
          )}
        >
          {children}
